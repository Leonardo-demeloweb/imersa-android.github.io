...
var DataTableComponent = (function () {
    ...
    DataTableComponent.prototype.deleteUser = function (userId) {
        var _this = this;
        var id = +userId;
        this.userService.deleteUserById(id).subscribe(function (success) {
            _this.initTable();
        }, function (error) { return console.log(error); });
    };
...
var DataTableComponent2 = (function () {
    ...
    DataTableComponent2.prototype.deleteMomento = function (momentoId) {
        var _this = this;
        var id = +momentoId;
        this.momentoService.deleteMomentoById(id).subscribe(function (success) {
            _this.initTable();
        }, function (error) { return console.log(error); });
    };
...
var DataTableComponent3 = (function () {
    ...
    DataTableComponent3.prototype.deleteConteudo = function (conteudoId) {
        var _this = this;
        console.log(conteudoId);
        this.conteudoService.deleteConteudoById(+conteudoId).subscribe(function (success) {
